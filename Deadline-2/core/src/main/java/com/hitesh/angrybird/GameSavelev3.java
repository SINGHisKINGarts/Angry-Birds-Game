...
public class GameSavelev3 implements Serializable {
    public static void saveGame(Level3 level) {
        try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("lvl3_game_save.ser"))) {
    ...
    public static void loadGame(Level3 level) {
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("lvl3_game_save.ser"))) {
    ...
    private static class SaveData implements Serializable {
        ...
        void restoreGameState(Level3 level) {
