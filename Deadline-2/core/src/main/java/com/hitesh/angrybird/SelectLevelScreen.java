...
//        stage = new Stage(new FitViewport(10.3f, 5.2f), spriteBatch);
...
//                Gdx.app.log("SelectLevelScreen", "Level 1 button clicked");
//                game.setScreen((Screen) new Level1(game)); // Transition to Level1Screen
//            }
//        });
...
//    @Override
//    public void show() {
//        Gdx.app.log("Level1", "Screen shown");
...
//
//        spriteBatch.begin();
//        spriteBatch.draw(levelScreenTexture, 0, 0, viewport.getWorldWidth(), viewport.getWorldHeight());
//        spriteBatch.end();
//
//        stage.act(delta);
//        stage.draw();
