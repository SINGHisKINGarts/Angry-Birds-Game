...
public class GameSaveManager implements Serializable {
    public static void saveGame(Level1 level) {
        try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("lvl1_game_save.ser"))) {
    ...
    public static void loadGame(Level1 level) {
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("lvl1_game_save.ser"))) {
    ...
    private static class SaveData implements Serializable {
        ...
        void restoreGameState(Level1 level) {
